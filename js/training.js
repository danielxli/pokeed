...
const WORD_PICTURE_POOL = [
  ...
  { word: 'jam', emoji: '🫙', level: 1 }, { word: 'bat', emoji: '🦇', level: 1 },
  { word: 'nut', emoji: '🥜', level: 1 }, { word: 'leg', emoji: '🦵', level: 1 },
  { word: 'pot', emoji: '🍯', level: 1 }, { word: 'van', emoji: '🚐', level: 1 },
  { word: 'gem', emoji: '💎', level: 1 }, { word: 'pie', emoji: '🥧', level: 1 },
  { word: 'bow', emoji: '🎀', level: 1 }, { word: 'mop', emoji: '🧹', level: 1 },
  ...
  { word: 'skip', emoji: '⏭️', level: 2 }, { word: 'snap', emoji: '🫰', level: 2 },
  ...
  { word: 'rope', emoji: '🪢', level: 2 }, { word: 'sock', emoji: '🧦', level: 2 },
  ...
  { word: 'web', emoji: '🕸️', level: 2 }, { word: 'cane', emoji: '🍬', level: 2 },
  { word: 'grape', emoji: '🍇', level: 2 }, { word: 'flame', emoji: '🔥', level: 2 },
  { word: 'slide', emoji: '🛝', level: 2 }, { word: 'globe', emoji: '🌍', level: 2 },
  { word: 'clip', emoji: '📎', level: 2 }, { word: 'grin', emoji: '😁', level: 2 },
  { word: 'snail', emoji: '🐌', level: 2 }, { word: 'broom', emoji: '🧹', level: 2 },
  { word: 'spoon', emoji: '🥄', level: 2 }, { word: 'truck', emoji: '🚛', level: 2 },
  { word: 'crib', emoji: '🛏️', level: 2 }, { word: 'plum', emoji: '🫐', level: 2 },
  { word: 'swan', emoji: '🦢', level: 2 }, { word: 'clam', emoji: '🐚', level: 2 },
  { word: 'bride', emoji: '👰', level: 2 }, { word: 'flute', emoji: '🎵', level: 2 },
  { word: 'skate', emoji: '⛸️', level: 2 }, { word: 'stone', emoji: '🪨', level: 2 },
  ...
  { word: 'cloud', emoji: '☁️', level: 3 }, { word: 'lamp', emoji: '💡', level: 3 },
  ...
  { word: 'ladder', emoji: '🪜', level: 3 }, { word: 'ribbon', emoji: '🎀', level: 3 },
  ...
  { word: 'window', emoji: '🪟', level: 3 }, { word: 'throne', emoji: '🪑', level: 3 },
  ...
  { word: 'compass', emoji: '🧭', level: 4 }, { word: 'crystal', emoji: '💎', level: 4 },
  { word: 'dolphin', emoji: '🐬', level: 4 }, { word: 'feather', emoji: '🪶', level: 4 },
  { word: 'treasure', emoji: '💰', level: 4 }, { word: 'trumpet', emoji: '🎺', level: 4 },
  { word: 'penguin', emoji: '🐧', level: 4 }, { word: 'lantern', emoji: '🏮', level: 4 },
  { word: 'pretzel', emoji: '🥨', level: 4 },
  { word: 'volcano', emoji: '🌋', level: 4 }, { word: 'whistle', emoji: '📯', level: 4 },
  { word: 'skeleton', emoji: '💀', level: 4 }, { word: 'mushroom', emoji: '🍄', level: 4 },
  { word: 'scissors', emoji: '✂️', level: 4 }, { word: 'sandwich', emoji: '🥪', level: 4 },
  { word: 'calendar', emoji: '📅', level: 4 }, { word: 'campfire', emoji: '🔥', level: 4 },
  ...
  { word: 'caterpillar', emoji: '🐛', level: 5 }, { word: 'binoculars', emoji: '🔭', level: 5 },
  { word: 'strawberry', emoji: '🍓', level: 5 }, { word: 'watermelon', emoji: '🍉', level: 5 },
  { word: 'dragonfly', emoji: '🪰', level: 5 }, { word: 'thermometer', emoji: '🌡️', level: 5 },
  { word: 'trampoline', emoji: '🤸', level: 5 }, { word: 'centipede', emoji: '🐛', level: 5 },
  { word: 'refrigerator', emoji: '🧊', level: 5 }, { word: 'xylophone', emoji: '🎶', level: 5 },
  { word: 'harmonica', emoji: '🎵', level: 5 }, { word: 'chimpanzee', emoji: '🐒', level: 5 },
];
