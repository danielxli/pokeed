...
const WORD_PICTURE_POOL = [
  ...
  { word: 'jam', emoji: '🫙', level: 1 },
  { word: 'fan', emoji: '🪭', level: 1 }, { word: 'lip', emoji: '👄', level: 1 },
  { word: 'mop', emoji: '🧹', level: 1 }, { word: 'pot', emoji: '🍲', level: 1 },
  { word: 'bow', emoji: '🎀', level: 1 },
  { word: 'cub', emoji: '🐻', level: 1 }, { word: 'wig', emoji: '💇', level: 1 },
  { word: 'ax', emoji: '🪓', level: 1 }, { word: 'top', emoji: '🔝', level: 1 },
  ...
  { word: 'plum', emoji: '🫐', level: 2 }, { word: 'cane', emoji: '🦯', level: 2 },
  { word: 'dice', emoji: '🎲', level: 2 }, { word: 'hive', emoji: '🐝', level: 2 },
  { word: 'flute', emoji: '🪈', level: 2 }, { word: 'crane', emoji: '🏗️', level: 2 },
  { word: 'stamp', emoji: '📬', level: 2 }, { word: 'crown', emoji: '👑', level: 2 },
  { word: 'shelf', emoji: '🗄️', level: 2 }, { word: 'stump', emoji: '🪵', level: 2 },
  { word: 'blade', emoji: '🗡️', level: 2 }, { word: 'stone', emoji: '🪨', level: 2 },
  { word: 'peach', emoji: '🍑', level: 2 }, { word: 'tooth', emoji: '🦷', level: 2 },
  ...
  { word: 'planet', emoji: '🪐', level: 3 }, { word: 'ribbon', emoji: '🎀', level: 3 },
  { word: 'cactus', emoji: '🌵', level: 3 }, { word: 'pencil', emoji: '✏️', level: 3 },
  { word: 'donkey', emoji: '🫏', level: 3 }, { word: 'guitar', emoji: '🎸', level: 3 },
  { word: 'barrel', emoji: '🛢️', level: 3 },
  { word: 'peanut', emoji: '🥜', level: 3 },
  { word: 'shield', emoji: '🛡️', level: 3 }, { word: 'wrench', emoji: '🔧', level: 3 },
  { word: 'potato', emoji: '🥔', level: 3 }, { word: 'walrus', emoji: '🦭', level: 3 },
  { word: 'unicorn', emoji: '🦄', level: 4 }, { word: 'tornado', emoji: '🌪️', level: 4 },
  { word: 'island', emoji: '🏝️', level: 4 }, { word: 'desert', emoji: '🏜️', level: 3 },
  { word: 'snake', emoji: '🐍', level: 2 },
  { word: 'parrot', emoji: '🦜', level: 4 }, { word: 'tiger', emoji: '🐅', level: 3 },
  ...
  { word: 'lightning', emoji: '⚡', level: 4 }, { word: 'cucumber', emoji: '🥒', level: 4 },
  { word: 'skeleton', emoji: '💀', level: 4 }, { word: 'backpack', emoji: '🎒', level: 4 },
  { word: 'treasure', emoji: '💰', level: 4 }, { word: 'starfish', emoji: '⭐', level: 4 },
  { word: 'keyboard', emoji: '⌨️', level: 4 }, { word: 'avocado', emoji: '🥑', level: 5 },
  { word: 'campfire', emoji: '🔥', level: 4 }, { word: 'lobster', emoji: '🦞', level: 4 },
  { word: 'popcorn', emoji: '🍿', level: 4 }, { word: 'bluebird', emoji: '🐦', level: 4 },
  { word: 'toadstool', emoji: '🍄', level: 4 }, { word: 'chipmunk', emoji: '🐿️', level: 4 },
  { word: 'envelope', emoji: '✉️', level: 4 }, { word: 'notebook', emoji: '📓', level: 4 },
  ...
  { word: 'caterpillar', emoji: '🐛', level: 5 }, { word: 'dragonfly', emoji: '🪰', level: 4 },
  { word: 'alligator', emoji: '🐊', level: 5 }, { word: 'binoculars', emoji: '🔭', level: 5 },
  { word: 'jellyfish', emoji: '🪼', level: 4 }, { word: 'trampoline', emoji: '🤸', level: 5 },
  { word: 'chameleon', emoji: '🦎', level: 5 }, { word: 'porcupine', emoji: '🦔', level: 5 },
  { word: 'sunflower', emoji: '🌻', level: 4 }, { word: 'chimpanzee', emoji: '🐒', level: 5 },
  { word: 'tambourine', emoji: '🪘', level: 5 }, { word: 'centipede', emoji: '🐛', level: 5 },
  { word: 'calculator', emoji: '🧮', level: 5 }, { word: 'triceratops', emoji: '🦕', level: 5 },
  { word: 'armadillo', emoji: '🦔', level: 5 }, { word: 'harmonica', emoji: '🎵', level: 5 },
];
